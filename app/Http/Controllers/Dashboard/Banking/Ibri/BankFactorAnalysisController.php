...
class BankFactorAnalysisController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $weights = VariableWeight::select('variable_masters.id', 'variable_masters.nama_variable', 'variable_weights.weight')
        ...
        $weightRanks = VariableWeight::select('variable_masters.id', 'variable_masters.nama_variable', 'variable_weights.weight')
        ->join('variable_masters', 'variable_weights.variable_masters_id', '=', 'variable_masters.id')
        ->orderBy('variable_weights.weight', 'desc')
        ->get();
        $i = 1;
