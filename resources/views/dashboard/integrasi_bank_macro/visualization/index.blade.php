    ...
    <section class="p-5">
        <div class="fle flex-col w-full mb-6">
            ...
            <div class="flex flex-row gap-2 mt-1">
                <span>Integrasi Bank & Macro, Visualization</span>
            </div>
        </div>
        ...
        $(document).ready(function() {
            ...
            async function reqSignal() {
                try {
                    const signal = await axios({
                        method: 'get',
                        url: '{{ route('dashboard.integrasi.performance.data' , ['code'  => \Route::current()->parameter('code') ]) }}',
                        headers: {},
                    })
            ...
            async function reqSignalLow() {
                try {
                    const signal = await axios({
                        method: 'get',
                        url: '{{ route('dashboard.integrasi.performance.data-lower', ['code'  => \Route::current()->parameter('code') ]) }}',
                        headers: {},
                    })
            ...
            async function renderData(){
                $('.skalz-tbody').append(`
                    <tr>
                        <td rowspan="2" class="border border-slate-300 py-4">${dataAll.name}</td>
                        ...
                        <td class="border border-slate-300 py-4">${dataAll.lowGsb}</td> 
                        <td class="border border-slate-300 py-4">${dataAll.resultData[13].toFixed(3)}</td>
                        <td class="border border-slate-300 py-4">${dataAll.resultData[14].toFixed(3)}</td> 
                        <td class="border border-slate-300 py-4">${dataAll.resultData[12].toFixed(3)}</td>
                        <td class="border border-slate-300 py-4">${(dataAll.resultData[17] * 100).toFixed(2)} %</td>
                    </tr>
                    <tr>
                        <td class="border border-slate-300 py-4">Lower Treshold</td>
                        <td class="border border-slate-300 py-4">${dataAll.lowGsbLow}</td>
                        <td class="border border-slate-300 py-4">${dataAll.resultDataLow[13].toFixed(3)}</td>
                        <td class="border border-slate-300 py-4">${dataAll.resultDataLow[14].toFixed(3)}</td>
                        <td class="border border-slate-300 py-4">${dataAll.resultDataLow[12].toFixed(3)}</td>
                        <td class="border border-slate-300 py-4">${(dataAll.resultDataLow[17] * 100).toFixed(2)} %</td>
                    </tr>
                `)
