    ...
    <section class="p-5">
        <div class="fle flex-col w-full mb-6">
            ...
            <div class="flex flex-row gap-2 mt-1">
                <span>Macro, Step Macro, Signaling Threshold, Lower Threshold</span>
            </div>
        </div>
        ...
        $(document).ready(function() {
            ...
            * */
            ...
            async function getData(period) {
                $('#tbodyUpper').html('')
                await axios.get('{{ route('dashboard.bank.macro.signaling.lower.data' , ['code' => \Route::current()->parameter('code')]) }}?periode='+period).then(resp => {
