                    ...
                    $('#tbody').append(`
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="py-4 px-6 flex flex-row gap-2 items-center justify-center">
                                <a href="/{{ \Route::current()->parameter('code') }}/dashboard/bank/macro/data/edit/${data[5]}/${data[6]}" class="py-0.5 px-2 bg-ds-yellow/20 text-ds-yellow rounded-lg cursor-pointer"><i class="fa-solid fa-pen"></i> Edit</a>
