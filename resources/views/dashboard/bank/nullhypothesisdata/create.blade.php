    ...
    <section class="p-5">
        <div class="fle flex-col w-full mb-6">
            ...
            <div class="flex flex-row gap-2 mt-1">
                <span>Add new Null Hypothesis</span>
            </div>
        </div>
                ...
                <div class="flex">
                    <div class="flex-1 w-64 mr-2">
                        ...
                        <div class="my-4">
                            ...
                            <input id="obs" type="text" name="obs" value="" placeholder="Masukkan Data"
                        ...
                        <div class="my-4">
                            ...
                            <input id="fStatistic1" type="text" name="fStatistic1" value=""
                        ...
                        <div class="my-4">
                            ...
                            <input id="prob1" type="text" name="prob1" value="" placeholder="Masukkan Data"
                                class="bg-gray-50 border border-gray-300 text-sm rounded-xl focus:ring-ds-gray focus:border-ds-gray block w-full p-2.5"
                                required>
                    ...
                    <div class="flex-1 w-64">
                        ...
                        <div class="my-4">
                            <label class="block mb-2 text-sm font-normal">F-Statistic</label>
                            <input id="fStatistic2" type="text" name="fStatistic2" value=""
                                placeholder="Masukkan Data"
                                class="bg-gray-50 border border-gray-300 text-sm rounded-xl focus:ring-ds-gray focus:border-ds-gray block w-full p-2.5"
                                required>
                        ...
                        <div class="my-4">
                            <label class="block mb-2 text-sm font-normal">Prob</label>
                            <input id="prob2" type="text" name="prob2" value="" placeholder="Masukkan Data"
                                class="bg-gray-50 border border-gray-300 text-sm rounded-xl focus:ring-ds-gray focus:border-ds-gray block w-full p-2.5"
                                required>
