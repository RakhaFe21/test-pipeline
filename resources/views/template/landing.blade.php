...
<body class="bg-ld-navbar">
            ...
            <div class="flex flex-row items-center ">
                <div class="hidden justify-between items-center w-full md:flex md:w-auto z-[0] absolute md:static top-[90px] left-0 right-0" id="mobile-menu-2">
                    <ul class="flex flex-col p-4 bg-ld-navbar md:flex-row md:gap-5">
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 text-ld-green font-medium">Tentang Kami</a>
                        </li>
                        <li>
    ...
    <nav class="flex flex-col bg-ld-green w-full items-center whitespace-nowrap px-4 lg:px-[100px] z-10">
        <div class="flex flex-row w-full h-[70px] overflow-auto">
            <div class="container mx-auto flex flex-row gap-5 items-center text-white-1">
                ...
                <a data-dropdown-toggle="dropdownNavbar" class="font-base px-4 hover:text-ld-yellow cursor-pointer">Bank</a>
                <div id="dropdownNavbar" class="hidden z-10 w-44 font-normal bg-ld-green">
                    <ul class="py-1 text-sm" aria-labelledby="dropdownLargeButton">
                        <li>
                            <a href="#" class="block py-2 px-4 hover:text-ld-yellow">Variable Used</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 hover:text-ld-yellow">Data</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 hover:text-ld-yellow">Theoritical Framework</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 hover:text-ld-yellow">The Heat Map</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 hover:text-ld-yellow">Visualization</a>
                        </li>
                    </ul>
                </div>
                <a href="#" class="text-white-1 font-base px-4 hover:text-ld-yellow">Macro</a>
                <a href="#" class="text-white-1 font-base px-4 hover:text-ld-yellow">Integrasi Bank & Macro</a>
            </div>
        </div>
    </nav>
    ...
    <footer class="w-full bg-ld-green pt-[50px]">
        <div class="container mx-auto grid grid-cols-1 gap-10 md:grid-cols-3 px-4 lg:px-[100px]">
            ...
            <div class="flex flex-col gap-2 w-full text-white-1">
                ...
                <span>Phone 1 : 0852232212</span>
                <span>Phone 2 : 0852232212</span>
                <span>Email : dev@mail.com</span>
            </div>
            <div class="flex flex-col gap-2 w-full text-white-1">
    ...
    <script>
        $(document).ready(function() {
             ...
             * Loading Button
             */
            const loadingButton = (loading, el, text) => {
                if (loading) {
