        ...
        $(document).ready(function() {
            ...
            Object.keys(bankingDataChild).forEach((key, index) => {
                $("#data-dropdown").append(`
                    <li>
                        <a href="dashboard/banking/data/${bankingDataChild[key].url}" class="flex items-center p-2 pl-3 w-full text-base font-normal text-gray-1 hover:text-blue-1 rounded-lg transition duration-75 group ">
